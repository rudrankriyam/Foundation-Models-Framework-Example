...
extension AppBenchScenarioCatalog {
    public static let guardrailExpectedResponse = AppBenchScenario(
    ...
    public static let guardrailExpectedProtection = AppBenchScenario(
...
private typealias SafetySampleBase = (prompt: String, checks: [AppBenchCheck])
