...
- Natural command groups for real workflows: `model`, `tag`, `session`, `schema`, `tool`, `transcript`, and `feedback`
...
`afm` exposes the key Foundation Models knobs directly instead of burying them inside demo presets:
