...
public enum AppBenchScenarioCatalog {
    ...
    public static let groundedExplanation = AppBenchScenario(
    ...
    public static let exerciseSubstitution = AppBenchScenario(
    ...
    public static let documentQuestionAnswering = AppBenchScenario(
    ...
    public static let citationExtraction = AppBenchScenario(
    ...
    public static let creativeWriting = AppBenchScenario(
        id: "creative-writing",
    ...
    public static let visualRecommendation = AppBenchScenario(
    ...
    public static let contextLimit = AppBenchScenario(
        id: "context-limit",
...
private typealias SampleBase = (prompt: String, checks: [AppBenchCheck])
