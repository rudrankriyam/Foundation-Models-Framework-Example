...
public struct AppBenchCheckResult: Codable, Sendable {
    public let label: String
    public let passed: Bool
    public let detail: String?
}

public struct AppBenchGrade: Codable, Sendable {
    public let checks: [AppBenchCheckResult]
...
public enum AppBenchGrader {
    ...
    private static func matches(_ actual: Any?, expected: AppBenchJSONValue) -> Bool {
        switch expected {
